      ...
      <PagerView style={styles.PagerView} initialPage={0}>
        ...
        <View style={styles.PagerRender} key="1">
          <Image
            ...
            source={require('../assets/images/startup_intro.png')}
          />
          <Text style={styles.introduction_top_text}>Welcome to Moon Meet</Text>
          <Text style={styles.introduction_bottom_text}>
        ...
        <View style={styles.PagerRender} key="2">
          <Image
            style={styles.illustration}
            source={require('../assets/images/chatting_intro.png')}
          />
          <Text style={styles.introduction_top_text}>
            Hanging out with your Relationships
          </Text>
          <Text style={styles.introduction_bottom_text}>
            Get in touch with your Relationships by inviting them to use Moon
            Meet and join the party with you.
          </Text>
        </View>
        <View style={styles.PagerRender} key="3">
          ...
          <Text style={styles.introduction_bottom_text}>
            Press the Continue button bellow to access to your Moon Meet Account
            or Sign Up
          </Text>
          <Button
            style={styles.introduction_button}
            uppercase={false}
            color="#566193"
            mode="contained"
            onPress={() => {
