...
import {isAndroid} from 'utils/device/DeviceInfo.ts';
import {
  BottomSheetBackdrop,
  BottomSheetModal,
  BottomSheetView,
...
const LoginHelp = (props: LoginHelpInterface) => {
   ...
   *
   * @param {BottomSheetDefaultBackdropProps} backProps - The properties for the backdrop.
   * @returns {ReactElement} - The rendered backdrop component.
   */
