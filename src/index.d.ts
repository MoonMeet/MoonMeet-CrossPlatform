...
import StarsBackground from '/assets/images/stars_background.png';
...
export {ChattingIntro, GetStarted, StartupIntro, WelcomeImage};

export {LoadingAnimation};

export {PurpleBackground, StarsBackground, ClearImage, LogoImage, RocketImage};
