    ...
    <BaseView style={styles.container}>
      ...
      {isAndroid ? (
        <ScrollView
          ...
          <Text style={styles.instruction}>
            - You must be able to receive SMS to the phone number you are trying
            to verify.
          </Text>
          <Text style={styles.instruction}>
          ...
          <Text style={styles.instruction}>
            ...
            Wi-Fi, if you're roaming or have a bad connection, verification may
            not work.
          </Text>
          ...
          <Text style={styles.instruction}>
            ...
            exactly as you entered it in Moon Meet, including the country code,
            to check your reception.
          </Text>
        </ScrollView>
      ) : (
        <ScrollView
          ...
          <Text
            ...
            if you have followed these steps and can't receive a code, please do
            the following:
          </Text>
          <Text style={styles.instruction}>
